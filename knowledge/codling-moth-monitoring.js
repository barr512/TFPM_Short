  ...
  "records": [
    ...
    },
    {
      ...
      "facts": [
        ...
        "Delta traps are the most common current style, but they are not the only trap body used for codling moth monitoring.",
        "Some growers also use bucket-style traps for codling moth monitoring.",
        "Large plastic delta traps are durable and reusable, and their replaceable sticky liners slide in and out of the trap body.",
        "Wing-style traps are another established pheromone-trap body; they are generally less durable and commonly last less than one season.",
        "Field comparisons indicate that codling moth catch in wing and delta traps is similar.",
        "Camera traps are an emerging monitoring option, but their different opening and automated system mean that catch interpretation should not automatically be assumed identical to traditional wing or delta traps.",
        "Older codling moth monitoring methods have included molasses-and-vinegar bait traps and black-light traps, although wing and delta pheromone traps are the established sticky-trap styles discussed for current orchard monitoring.",
    ...
    },
    {
      ...
      "facts": [
        ...
        "Without mating disruption, sustained captures in an appropriate pheromone-baited monitoring trap can be used to establish biofix.",
        "Once mating disruption is operating, catches in a standard sex-pheromone trap may remain near zero even when codling moth is present, making a trap-catch biofix difficult or unreliable.",
        "The same biofix instructions must not be presented for disrupted and non-disrupted orchards without explaining this difference.",
